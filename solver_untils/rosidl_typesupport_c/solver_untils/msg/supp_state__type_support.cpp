...
static const _SuppState_type_support_symbol_names_t _SuppState_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, solver_untils, msg, SuppState)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, solver_untils, msg, SuppState)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, solver_untils, msg, SuppState)() {
  return &::solver_untils::msg::rosidl_typesupport_c::SuppState_message_type_support_handle;
}
